"""
Django settings for PrestamoAsegurado project.
...
SECRET_KEY = '^otf*#ph07bqq&%vg3$v)d%p5pt0f35rswh%i(l8ro^u6sz2o$'
...
WSGI_APPLICATION = 'PrestamoAsegurado.wsgi.application'
